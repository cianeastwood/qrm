...
if __name__ == "__main__":
    ...
    parser.add_argument('--partition', '-p', type=str, default='Teach-Standard')
    ...
    parser.add_argument('--slurm-exclude', '-se', type=str,
                        help="Names of the cluster nodes to be excluded.")
    parser.add_argument('--nodes', type=int, default=1)
    parser.add_argument('--cpus-per-task', '-nc', type=int, default=4)
    parser.add_argument('--gpus-per-node', '-ng', type=int, default=0)
    ...
    executor.update_parameters(
        ...
        tasks_per_node=max(1, args.gpus_per_node),  # one task per GPU
